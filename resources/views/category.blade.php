...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <label for="fname">Catégory : </label>
         <input type="text" id="fname" name="fname" placeholder="Entree Catégory..."><br>
         <button>Add Catégory</button>
        ...
        <div class="menu">
            ...
            <a href="/"><i id="cc"class="fa fa-home" aria-hidden="true"></i>            Acceuil</a>
                <a href="/Student"><i id="cc"class="fa fa-search" aria-hidden="true"></i>  Cherche Livres</a>
                ...
                <a class="ac"  href="/category"><i id="cc"class="fa fa-server" aria-hidden="true"></i>  Catégory</button>
